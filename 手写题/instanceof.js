 ...
 * 原理描述：在原型链上一层一层查找，找类constructor.prototype 是否存在于实例的原型链上。(对象的原型链上是否能够找到类的prototype)
 * */
const object = {};
const array = [];
...
// const testInstanceof = function (example, classFun) {
//   let proto = Object.getPrototypeOf(example); // 取的当前实例对象的原型链
//   while (true) {
